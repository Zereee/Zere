...
document.write("Hello! My name is Zere and my group is CS-2123" + '<p>');
...
document.write(Math.ceil((univer.getTime()-today.getTime())/(one_day))+ '<em>' + " days left until the freedom!" + '</em>' + '<p>');
